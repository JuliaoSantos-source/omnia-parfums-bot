...
// ===================================================
const CATALOGO = {
  'dior homme intense edp': { nome: 'Dior Homme Intense EDP', nomeBase: 'Dior Homme Intense', genero: 'M', conc: 'EDP', familia: 'Floral Almíscar', nicho: false, preco: {'50ml': 168200, '100ml': 212200}, notas: 'Íris, Cedro, Âmbar'  },
  'chanel n°5 edp': { nome: 'Chanel N°5 EDP', nomeBase: 'Chanel N°5', genero: 'F', conc: 'EDP', familia: 'Floral Aldéidico', nicho: false, preco: {'35ml': 168200, '50ml': 212200, '100ml': 283000}, notas: 'Ylang-ylang, Íris, Almíscar, Âmbar'  },
  'ysl y parfum': { nome: 'YSL Y Parfum', nomeBase: 'YSL Y', genero: 'M', conc: 'Parfum', familia: 'Amadeirado Especiado', nicho: false, preco: {'60ml': 204400}, notas: 'Bergamota, Coriandro, Vetiver'  },
  'rabanne 1 million parfum': { nome: 'Rabanne 1 Million Parfum', nomeBase: 'Rabanne 1 Million', genero: 'M', conc: 'Parfum', familia: 'Oriental Especiado', nicho: false, preco: {'50ml': 183900, '100ml': 235800}, notas: 'Tonka, Baunilha, Salgado'  },
  'rabanne phantom edt': { nome: 'Rabanne Phantom EDT', nomeBase: 'Rabanne Phantom', genero: 'M', conc: 'EDT', familia: 'Lavanda Amadeirado', nicho: false, preco: {'50ml': 152500, '100ml': 191800}, notas: 'Limão, Lavanda, Vetiver'  },
  'rabanne fame edp': { nome: 'Rabanne Fame EDP', nomeBase: 'Rabanne Fame', genero: 'F', conc: 'EDP', familia: 'Floral Almíscar', nicho: false, preco: {'30ml': 143100, '50ml': 169800, '80ml': 212200}, notas: 'Mandarina, Jasmim, Patchouli'  },
  'lancôme idôle edp': { nome: 'Lancôme Idôle EDP', nomeBase: 'Lancôme Idôle', genero: 'F', conc: 'EDP', familia: 'Floral', nicho: false, preco: {'25ml': 125800, '50ml': 161900, '100ml': 207500}, notas: 'Rosa de Grasse, Almíscar, Âmbar'  },
  'lancôme trésor edp': { nome: 'Lancôme Trésor EDP', nomeBase: 'Lancôme Trésor', genero: 'F', conc: 'EDP', familia: 'Floral Oriental', nicho: false, preco: {'30ml': 122600, '50ml': 149300, '100ml': 191800}, notas: 'Pêssego, Rosa, Almíscar, Âmbar'  },
  'versace eros parfum': { nome: 'Versace Eros Parfum', nomeBase: 'Versace Eros', genero: 'M', conc: 'Parfum', familia: 'Oriental Aromático', nicho: false, preco: {'50ml': 180800}, notas: 'Lichia, Néroli, Âmbar, Vetiver'  },
  'versace eros flame edp': { nome: 'Versace Eros Flame EDP', nomeBase: 'Versace Eros Flame', genero: 'M', conc: 'EDP', familia: 'Amadeirado Especiado', nicho: false, preco: {'50ml': 154100, '100ml': 196500}, notas: 'Toranja, Romã, Patchouli'  },
  'versace bright crystal edt': { nome: 'Versace Bright Crystal EDT', nomeBase: 'Versace Bright Crystal', genero: 'F', conc: 'EDT', familia: 'Floral Almíscar', nicho: false, preco: {'30ml': 117900, '50ml': 141500, '90ml': 177600}, notas: 'Romã, Peónia, Almíscar'  },
  'versace dylan blue pour femme edp': { nome: 'Versace Dylan Blue Pour Femme EDP', nomeBase: 'Versace Dylan Blue Pour Femme', genero: 'F', conc: 'EDP', familia: 'Floral Frutal', nicho: false, preco: {'50ml': 147800, '100ml': 188600}, notas: 'Groselha, Peónia, Âmbar Branco'  },
  'hugo boss bottled edt': { nome: 'Hugo Boss Bottled EDT', nomeBase: 'Hugo Boss Bottled', genero: 'M', conc: 'EDT', familia: 'Amadeirado Especiado', nicho: false, preco: {'30ml': 88000, '50ml': 95900, '100ml': 110000, '200ml': 133600}, notas: 'Maçã, Madeira de Sândalo, Cedro'  },
  'hugo boss bottled edp': { nome: 'Hugo Boss Bottled EDP', nomeBase: 'Hugo Boss Bottled', genero: 'M', conc: 'EDP', familia: 'Amadeirado Especiado', nicho: false, preco: {'50ml': 97500, '100ml': 113200}, notas: 'Maçã, Lavanda, Sândalo'  },
  'hugo boss the scent edt': { nome: 'Hugo Boss The Scent EDT', nomeBase: 'Hugo Boss The Scent', genero: 'M', conc: 'EDT', familia: 'Oriental Amadeirado', nicho: false, preco: {'50ml': 113200, '100ml': 138300, '200ml': 158800}, notas: 'Gengibre, Osmanthus, Couro'  },
  'hugo boss the scent for her edp': { nome: 'Hugo Boss The Scent For Her EDP', nomeBase: 'Hugo Boss The Scent For Her', genero: 'F', conc: 'EDP', familia: 'Floral Oriental', nicho: false, preco: {'30ml': 122600, '50ml': 146200}, notas: 'Framboesa, Osmanthus, Âmbar'  },
  'narciso rodriguez for her edp': { nome: 'Narciso Rodriguez For Her EDP', nomeBase: 'Narciso Rodriguez For Her', genero: 'F', conc: 'EDP', familia: 'Floral Almíscar', nicho: false, preco: {'30ml': 110000, '50ml': 128900, '100ml': 155600, '150ml': 185500}, notas: 'Rosa, Almíscar, Âmbar'  },
  'narciso rodriguez musc noir rose edp': { nome: 'Narciso Rodriguez Musc Noir Rose EDP', nomeBase: 'Narciso Rodriguez Musc Noir Rose', genero: 'F', conc: 'EDP', familia: 'Floral Almíscar', nicho: false, preco: {'30ml': 121000, '50ml': 141500}, notas: 'Rosa, Almíscar Negro, Sândalo'  },
  'calvin klein eternity edp': { nome: 'Calvin Klein Eternity EDP', nomeBase: 'Calvin Klein Eternity', genero: 'F', conc: 'EDP', familia: 'Floral', nicho: false, preco: {'30ml': 110000, '50ml': 135200, '100ml': 165100}, notas: 'Orquídea, Almíscar, Sândalo'  },
  'calvin klein obsession edp': { nome: 'Calvin Klein Obsession EDP', nomeBase: 'Calvin Klein Obsession', genero: 'F', conc: 'EDP', familia: 'Oriental', nicho: false, preco: {'50ml': 138300, '100ml': 169800}, notas: 'Especiarias, Almíscar, Baunilha'  },
  'tom ford oud wood edp': { nome: 'Tom Ford Oud Wood EDP', nomeBase: 'Tom Ford Oud Wood', genero: 'U', conc: 'EDP', familia: 'Amadeirado Oriental', nicho: false, preco: {'50ml': 434300, '100ml': 613100}, notas: 'Oud, Sândalo, Vetiver'  },
  'tom ford black orchid edp': { nome: 'Tom Ford Black Orchid EDP', nomeBase: 'Tom Ford Black Orchid', genero: 'U', conc: 'EDP', familia: 'Oriental Floral', nicho: false, preco: {'50ml': 369600, '100ml': 545000}, notas: 'Trufa, Orquídea Preta, Patchouli'  },
  'tom ford tobacco vanille edp': { nome: 'Tom Ford Tobacco Vanille EDP', nomeBase: 'Tom Ford Tobacco Vanille', genero: 'U', conc: 'EDP', familia: 'Oriental Especiado', nicho: false, preco: {'50ml': 539900, '100ml': 783400}, notas: 'Tabaco, Baunilha, Madeira de Cedro'  },
  'tom ford neroli portofino edp': { nome: 'Tom Ford Neroli Portofino EDP', nomeBase: 'Tom Ford Neroli Portofino', genero: 'U', conc: 'EDP', familia: 'Cítrico Floral', nicho: false, preco: {'50ml': 437700, '100ml': 630100}, notas: 'Bergamota, Néroli, Âmbar'  },
  'tom ford lost cherry edp': { nome: 'Tom Ford Lost Cherry EDP', nomeBase: 'Tom Ford Lost Cherry', genero: 'U', conc: 'EDP', familia: 'Floral Frutal', nicho: false, preco: {'50ml': 507500, '100ml': 757800}, notas: 'Cereja, Âmbar, Baunilha'  },
  'tom ford rose prick edp': { nome: 'Tom Ford Rose Prick EDP', nomeBase: 'Tom Ford Rose Prick', genero: 'U', conc: 'EDP', familia: 'Floral', nicho: false, preco: {'50ml': 507500}, notas: 'Rosa, Pimenta, Fava de Tonka'  },
  'guerlain mon guerlain edp': { nome: 'Guerlain Mon Guerlain EDP', nomeBase: 'Guerlain Mon Guerlain', genero: 'F', conc: 'EDP', familia: 'Floral Gourmand', nicho: false, preco: {'30ml': 143100, '50ml': 176100, '100ml': 229500}, notas: 'Lavanda, Baunilha, Almíscar'  },
  'guerlain la petite robe noire edp': { nome: 'Guerlain La Petite Robe Noire EDP', nomeBase: 'Guerlain La Petite Robe Noire', genero: 'F', conc: 'EDP', familia: 'Floral Frutal Gourmand', nicho: false, preco: {'30ml': 135200, '50ml': 165100, '100ml': 212200}, notas: 'Bergamota, Rosa, Alcaçuz, Patchouli'  },
  'mugler angel nova edp': { nome: 'Mugler Angel Nova EDP', nomeBase: 'Mugler Angel Nova', genero: 'F', conc: 'EDP', familia: 'Floral Gourmand', nicho: false, preco: {'50ml': 176100}, notas: 'Lavanda, Pralinê, Almíscar'  },
  'mugler alien edp': { nome: 'Mugler Alien EDP', nomeBase: 'Mugler Alien', genero: 'F', conc: 'EDP', familia: 'Floral Amadeirado', nicho: false, preco: {'30ml': 143100, '60ml': 185500}, notas: 'Jasmim, Âmbar Branco, Madeira de Caxemira'  },
  'mugler a*men edt': { nome: 'Mugler A*Men EDT', nomeBase: 'Mugler A*Men', genero: 'M', conc: 'EDT', familia: 'Oriental Especiado', nicho: false, preco: {'50ml': 149300}, notas: 'Café, Patchouli, Âmbar'  },
  'mugler a*men parfum': { nome: 'Mugler A*Men Parfum', nomeBase: 'Mugler A*Men', genero: 'M', conc: 'Parfum', familia: 'Oriental Especiado', nicho: false, preco: {'50ml': 180800}, notas: 'Café, Patchouli, Baunilha, Âmbar'  },
  'mancera cedrat boise': { nome: 'Mancera Cedrat Boise', nomeBase: 'Mancera Cedrat Boise', genero: 'U', conc: 'EDP', familia: 'Cítrico Amadeirado', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Limão, Cassis, Vetiver, Cedro'  },
  'mancera instant crush': { nome: 'Mancera Instant Crush', nomeBase: 'Mancera Instant Crush', genero: 'U', conc: 'EDP', familia: 'Floral Gourmand', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Laranja, Rosa, Baunilha, Âmbar'  },
  'mancera roses vanille': { nome: 'Mancera Roses Vanille', nomeBase: 'Mancera Roses Vanille', genero: 'F', conc: 'EDP', familia: 'Floral Gourmand', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Rosa, Baunilha, Patchouli'  },
  'mancera red tobacco': { nome: 'Mancera Red Tobacco', nomeBase: 'Mancera Red Tobacco', genero: 'U', conc: 'EDP', familia: 'Amadeirado Oriental', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Tabaco, Rosa, Especiarias, Âmbar'  },
  'mancera amore caffè': { nome: 'Mancera Amore Caffè', nomeBase: 'Mancera Amore Caffè', genero: 'U', conc: 'EDP', familia: 'Gourmand Oriental', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Café, Baunilha, Patchouli'  },
  'mancera french riviera': { nome: 'Mancera French Riviera', nomeBase: 'Mancera French Riviera', genero: 'U', conc: 'EDP', familia: 'Cítrico Marinho', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Bergamota, Cedro, Âmbar Branco'  },
  'mancera tonka cola': { nome: 'Mancera Tonka Cola', nomeBase: 'Mancera Tonka Cola', genero: 'U', conc: 'EDP', familia: 'Gourmand', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Tonka, Cola, Baunilha'  },
  'mancera coco vanille': { nome: 'Mancera Coco Vanille', nomeBase: 'Mancera Coco Vanille', genero: 'F', conc: 'EDP', familia: 'Gourmand Floral', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Coco, Baunilha, Almíscar'  },
  'mancera sicily': { nome: 'Mancera Sicily', nomeBase: 'Mancera Sicily', genero: 'U', conc: 'EDP', familia: 'Cítrico Floral', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Limão Siciliano, Bergamota, Néroli'  },
  'mancera black gold': { nome: 'Mancera Black Gold', nomeBase: 'Mancera Black Gold', genero: 'M', conc: 'EDP', familia: 'Oriental Amadeirado', nicho: true, preco: {'60ml': 315100, '120ml': 422300}, notas: 'Oud, Baunilha, Âmbar, Sândalo'  },
  'mancera wild fruits': { nome: 'Mancera Wild Fruits', nomeBase: 'Mancera Wild Fruits', genero: 'U', conc: 'EDP', familia: 'Floral Frutal', nicho: true, preco: {'60ml': 306500, '120ml': 408700}, notas: 'Frutas Silvestres, Rosa, Âmbar'  },
  'montale arabians tonka': { nome: 'Montale Arabians Tonka', nomeBase: 'Montale Arabians Tonka', genero: 'U', conc: 'EDP', familia: 'Oriental Amadeirado', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Açafrão, Oud, Rosa, Tonka'  },
  'montale roses musk': { nome: 'Montale Roses Musk', nomeBase: 'Montale Roses Musk', genero: 'F', conc: 'EDP', familia: 'Floral Almíscar', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Rosa, Almíscar, Âmbar'  },
  'montale intense café': { nome: 'Montale Intense Café', nomeBase: 'Montale Intense Café', genero: 'U', conc: 'EDP', familia: 'Floral Gourmand', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Rosa, Café, Baunilha, Âmbar'  },
  'montale black aoud': { nome: 'Montale Black Aoud', nomeBase: 'Montale Black Aoud', genero: 'M', conc: 'EDP', familia: 'Amadeirado Floral', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Oud, Rosa, Patchouli, Vetiver'  },
  'montale dark aoud': { nome: 'Montale Dark Aoud', nomeBase: 'Montale Dark Aoud', genero: 'M', conc: 'EDP', familia: 'Amadeirado Oriental', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Oud, Sândalo, Almíscar Negro'  },
  'montale amber musk': { nome: 'Montale Amber Musk', nomeBase: 'Montale Amber Musk', genero: 'U', conc: 'EDP', familia: 'Almíscar Âmbar', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Âmbar, Almíscar, Baunilha'  },
  'montale starry nights': { nome: 'Montale Starry Nights', nomeBase: 'Montale Starry Nights', genero: 'U', conc: 'EDP', familia: 'Oriental Floral', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Rosa Selvagem, Violeta, Açafrão'  },
  'montale vanilla cake': { nome: 'Montale Vanilla Cake', nomeBase: 'Montale Vanilla Cake', genero: 'F', conc: 'EDP', familia: 'Gourmand', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Baunilha, Leite, Caramelo'  },
  'montale rose elixir': { nome: 'Montale Rose Elixir', nomeBase: 'Montale Rose Elixir', genero: 'F', conc: 'EDP', familia: 'Floral', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Rosa, Almíscar, Vetiver'  },
  'montale sensual instinct': { nome: 'Montale Sensual Instinct', nomeBase: 'Montale Sensual Instinct', genero: 'U', conc: 'EDP', familia: 'Oriental', nicho: true, preco: {'50ml': 371300, '100ml': 391700}, notas: 'Açafrão, Oud, Patchouli'  },
  'creed aventus': { nome: 'Creed Aventus', nomeBase: 'Creed Aventus', genero: 'M', conc: 'EDP', familia: 'Frutal Chypre', nicho: true, preco: {'50ml': 374700, '100ml': 519400}, notas: 'Bergamota, Groselha Preta, Bétula, Almíscar'  },
  'creed aventus for her': { nome: 'Creed Aventus for Her', nomeBase: 'Creed Aventus for Her', genero: 'F', conc: 'EDP', familia: 'Floral Frutal', nicho: true, preco: {'50ml': 367800, '75ml': 459800}, notas: 'Bergamota, Rosa, Baunilha'  },
  'creed green irish tweed': { nome: 'Creed Green Irish Tweed', nomeBase: 'Creed Green Irish Tweed', genero: 'M', conc: 'EDT', familia: 'Fougère', nicho: true, preco: {'50ml': 369600, '100ml': 510900}, notas: 'Íris, Sândalo, Âmbar'  },
  'creed millesime imperial': { nome: 'Creed Millesime Imperial', nomeBase: 'Creed Millesime Imperial', genero: 'U', conc: 'EDP', familia: 'Aquático', nicho: true, preco: {'50ml': 369600, '100ml': 510900}, notas: 'Bergamota, Alga, Almíscar'  },
  'parfums de marly layton': { nome: 'Parfums de Marly Layton', nomeBase: 'Parfums de Marly Layton', genero: 'M', conc: 'EDP', familia: 'Floral Gourmand', nicho: true, preco: {'75ml': 306500, '125ml': 383200}, notas: 'Maçã, Lavanda, Baunilha, Sândalo'  },
  'parfums de marly layton exclusif': { nome: 'Parfums de Marly Layton Exclusif', nomeBase: 'Parfums de Marly Layton Exclusif', genero: 'M', conc: 'EDP', familia: 'Floral Gourmand', nicho: true, preco: {'75ml': 332100}, notas: 'Maçã, Lavanda, Noz-moscada, Sândalo'  },
  'parfums de marly delina': { nome: 'Parfums de Marly Delina', nomeBase: 'Parfums de Marly Delina', genero: 'F', conc: 'EDP', familia: 'Floral', nicho: true, preco: {'75ml': 298000, '125ml': 374700}, notas: 'Rhubarbo, Peónia, Rosa de Maio'  },
  'parfums de marly delina exclusif': { nome: 'Parfums de Marly Delina Exclusif', nomeBase: 'Parfums de Marly Delina Exclusif', genero: 'F', conc: 'EDP', familia: 'Floral', nicho: true, preco: {'75ml': 357600}, notas: 'Rhubarbo, Peónia, Rosa, Almíscar'  },
  'parfums de marly pegasus': { nome: 'Parfums de Marly Pegasus', nomeBase: 'Parfums de Marly Pegasus', genero: 'M', conc: 'EDP', familia: 'Floral Gourmand', nicho: true, preco: {'75ml': 298000, '125ml': 374700}, notas: 'Lavanda, Almendra, Baunilha, Sândalo'  },
  'parfums de marly percival': { nome: 'Parfums de Marly Percival', nomeBase: 'Parfums de Marly Percival', genero: 'M', conc: 'EDP', familia: 'Fougère', nicho: true, preco: {'75ml': 298000}, notas: 'Bergamota, Lavanda, Almíscar'  },
  'parfums de marly cassili': { nome: 'Parfums de Marly Cassili', nomeBase: 'Parfums de Marly Cassili', genero: 'F', conc: 'EDP', familia: 'Floral', nicho: true, preco: {'75ml': 298000}, notas: 'Rosa, Almíscar, Sândalo'  },
  'initio oud for greatness': { nome: 'Initio Oud for Greatness', nomeBase: 'Initio Oud for Greatness', genero: 'U', conc: 'EDP', familia: 'Amadeirado Especiado', nicho: true, preco: {'90ml': 604600}, notas: 'Oud, Almíscar, Especiarias, Âmbar'  },
  'initio atomic rose': { nome: 'Initio Atomic Rose', nomeBase: 'Initio Atomic Rose', genero: 'U', conc: 'EDP', familia: 'Floral', nicho: true, preco: {'90ml': 604600}, notas: 'Rosa, Almíscar, Âmbar'  },
  'initio black gold': { nome: 'Initio Black Gold', nomeBase: 'Initio Black Gold', genero: 'U', conc: 'EDP', familia: 'Oriental Amadeirado', nicho: true, preco: {'90ml': 604600}, notas: 'Sândalo, Âmbar, Almíscar'  },
  'initio rehab': { nome: 'Initio Rehab', nomeBase: 'Initio Rehab', genero: 'U', conc: 'EDP', familia: 'Gourmand', nicho: true, preco: {'90ml': 604600}, notas: 'Baunilha, Almíscar, Patchouli'  },
  'xerjoff nio': { nome: 'Xerjoff Nio', nomeBase: 'Xerjoff Nio', genero: 'U', conc: 'EDP', familia: 'Cítrico Verde', nicho: true, preco: {'50ml': 246900, '100ml': 318500}, notas: 'Yuzu, Menta, Madeira'  },
  'xerjoff oud stars alexandria ii': { nome: 'Xerjoff Oud Stars Alexandria II', nomeBase: 'Xerjoff Oud Stars Alexandria II', genero: 'U', conc: 'EDP', familia: 'Oriental', nicho: true, preco: {'50ml': 621600}, notas: 'Oud, Sândalo, Rosa'  },
  'mfk baccarat rouge 540 edp': { nome: 'MFK Baccarat Rouge 540 EDP', nomeBase: 'MFK Baccarat Rouge 540', genero: 'U', conc: 'EDP', familia: 'Floral Âmbar', nicho: true, preco: {'70ml': 720400}, notas: 'Jasmim, Açafrão, Cedro Âmbar'  },
  'mfk baccarat rouge 540 extrait': { nome: 'MFK Baccarat Rouge 540 Extrait', nomeBase: 'MFK Baccarat Rouge 540 Extrait', genero: 'U', conc: 'Extrait', familia: 'Floral Âmbar', nicho: true, preco: {'70ml': 851500}, notas: 'Jasmim, Açafrão, Cedro Âmbar'  },
  'mfk 724 edp': { nome: 'MFK 724 EDP', nomeBase: 'MFK 724', genero: 'U', conc: 'EDP', familia: 'Floral Amadeirado', nicho: true, preco: {'70ml': 630100}, notas: 'Bergamota, Lentisco, Almíscar'  },
  'mfk grand soir edp': { nome: 'MFK Grand Soir EDP', nomeBase: 'MFK Grand Soir', genero: 'U', conc: 'EDP', familia: 'Oriental', nicho: true, preco: {'70ml': 630100}, notas: 'Âmbar, Baunilha, Almíscar'  },
  'mfk gentle fluidity gold edp': { nome: 'MFK Gentle Fluidity Gold EDP', nomeBase: 'MFK Gentle Fluidity Gold', genero: 'U', conc: 'EDP', familia: 'Amadeirado Oriental', nicho: true, preco: {'70ml': 630100}, notas: 'Noz-moscada, Âmbar, Baunilha'  },
  'by kilian angels share edp': { nome: 'By Kilian Angels Share EDP', nomeBase: 'By Kilian Angels Share', genero: 'U', conc: 'EDP', familia: 'Gourmand', nicho: true, preco: {'50ml': 468300}, notas: 'Conhaque, Baunilha, Canela, Âmbar'  },
  'by kilian good girl gone bad edp': { nome: 'By Kilian Good Girl Gone Bad EDP', nomeBase: 'By Kilian Good Girl Gone Bad', genero: 'F', conc: 'EDP', familia: 'Floral', nicho: true, preco: {'50ml': 468300}, notas: 'Ylang, Magnólia, Rosa, Íris'  },
  'amouage reflection man edp': { nome: 'Amouage Reflection Man EDP', nomeBase: 'Amouage Reflection Man', genero: 'M', conc: 'EDP', familia: 'Floral Aromático', nicho: true, preco: {'50ml': 313400, '100ml': 400200}, notas: 'Alecrim, Íris, Sândalo'  },
  'amouage interlude man edp': { nome: 'Amouage Interlude Man EDP', nomeBase: 'Amouage Interlude Man', genero: 'M', conc: 'EDP', familia: 'Oriental Especiado', nicho: true, preco: {'50ml': 313400}, notas: 'Incenso, Âmbar, Orégão'  },
  'amouage memoir man edp': { nome: 'Amouage Memoir Man EDP', nomeBase: 'Amouage Memoir Man', genero: 'M', conc: 'EDP', familia: 'Floral Amadeirado', nicho: true, preco: {'50ml': 313400}, notas: 'Absinto, Incenso, Âmbar'  },
  'amouage gold woman edp': { nome: 'Amouage Gold Woman EDP', nomeBase: 'Amouage Gold Woman', genero: 'F', conc: 'EDP', familia: 'Floral Oriental', nicho: true, preco: {'50ml': 313400}, notas: 'Rosa, Jasmim, Incenso, Âmbar'  },
  'frederic malle portrait of a lady edp': { nome: 'Frederic Malle Portrait of a Lady EDP', nomeBase: 'Frederic Malle Portrait of a Lady', genero: 'F', conc: 'EDP', familia: 'Floral Oriental', nicho: true, preco: {'50ml': 640300, '100ml': 839600}, notas: 'Rosa, Patchouli, Sândalo, Âmbar'  },
  'frederic malle musc ravageur edp': { nome: 'Frederic Malle Musc Ravageur EDP', nomeBase: 'Frederic Malle Musc Ravageur', genero: 'U', conc: 'EDP', familia: 'Oriental', nicho: true, preco: {'50ml': 613100}, notas: 'Âmbar, Almíscar, Baunilha'  },
  'frederic malle cologne indelebile edp': { nome: 'Frederic Malle Cologne Indelebile EDP', nomeBase: 'Frederic Malle Cologne Indelebile', genero: 'U', conc: 'EDP', familia: 'Floral', nicho: true, preco: {'50ml': 613100}, notas: 'Almíscar, Néroli, Jasmim'  },
  'roja dove enigma edp': { nome: 'Roja Dove Enigma EDP', nomeBase: 'Roja Dove Enigma', genero: 'M', conc: 'EDP', familia: 'Oriental Amadeirado', nicho: true, preco: {'50ml': 970700}, notas: 'Bergamota, Rosa, Incenso, Âmbar'  },
  'roja dove elysium edp': { nome: 'Roja Dove Elysium EDP', nomeBase: 'Roja Dove Elysium', genero: 'M', conc: 'EDP', familia: 'Fougère', nicho: true, preco: {'50ml': 970700}, notas: 'Bergamota, Lavanda, Sândalo'  },
  'roja dove danger edp': { nome: 'Roja Dove Danger EDP', nomeBase: 'Roja Dove Danger', genero: 'M', conc: 'EDP', familia: 'Oriental Especiado', nicho: true, preco: {'50ml': 970700}, notas: 'Cítrico, Rosa, Âmbar'  },
  'roja dove scandal edp': { nome: 'Roja Dove Scandal EDP', nomeBase: 'Roja Dove Scandal', genero: 'F', conc: 'EDP', familia: 'Floral Chypre', nicho: true, preco: {'50ml': 970700}, notas: 'Aldeídos, Rosa, Âmbar'  },
  ...
  'dior sauvage edt': { nome: 'Dior Sauvage EDT', nomeBase: 'Dior Sauvage', genero: 'M', conc: 'EDT', familia: 'Amadeirado Aromático', nicho: false, preco: {'30ml': 110000, '60ml': 125800, '100ml': 157200, '200ml': 204400}, notas: 'Bergamota, Ambroxan, Pimenta Rosa'  },
  'dior sauvage edp': { nome: 'Dior Sauvage EDP', nomeBase: 'Dior Sauvage', genero: 'M', conc: 'EDP', familia: 'Oriental Fougère', nicho: false, preco: {'30ml': 121000, '60ml': 136800, '100ml': 168200, '200ml': 220100}, notas: 'Bergamota, Lavanda, Baunilha'  },
  'dior sauvage elixir': { nome: 'Dior Sauvage Elixir', nomeBase: 'Dior Sauvage Elixir', genero: 'M', conc: 'Extrait', familia: 'Especiado Aromático', nicho: false, preco: {'60ml': 251500}, notas: 'Cardamomo, Lavanda, Patchouli'  },
  'dior miss dior edp': { nome: 'Dior Miss Dior EDP', nomeBase: 'Dior Miss Dior', genero: 'F', conc: 'EDP', familia: 'Floral Aromático', nicho: false, preco: {'30ml': 146200, '50ml': 176100, '100ml': 224800}, notas: 'Peónia, Rosa, Patchouli'  },
  'bleu de chanel edt': { nome: 'Bleu de Chanel EDT', nomeBase: 'Bleu de Chanel', genero: 'M', conc: 'EDT', familia: 'Amadeirado Aromático', nicho: false, preco: {'50ml': 177600, '100ml': 223200, '150ml': 275100}, notas: 'Citrus, Incenso, Sândalo'  },
  'bleu de chanel edp': { nome: 'Bleu de Chanel EDP', nomeBase: 'Bleu de Chanel', genero: 'M', conc: 'EDP', familia: 'Amadeirado Aromático', nicho: false, preco: {'50ml': 199600, '100ml': 256200, '150ml': 314400}, notas: 'Citrus, Noz-moscada, Sândalo'  },
  'bleu de chanel parfum': { nome: 'Bleu de Chanel Parfum', nomeBase: 'Bleu de Chanel', genero: 'M', conc: 'Parfum', familia: 'Amadeirado Aromático', nicho: false, preco: {'50ml': 237400, '100ml': 303400}, notas: 'Citrus, Bétula, Âmbar'  },
  'chanel coco mademoiselle edp': { nome: 'Chanel Coco Mademoiselle EDP', nomeBase: 'Chanel Coco Mademoiselle', genero: 'F', conc: 'EDP', familia: 'Oriental Floral', nicho: false, preco: {'50ml': 209100, '100ml': 275100, '150ml': 334800}, notas: 'Bergamota, Rosa, Patchouli'  },
  'chanel chance eau tendre edp': { nome: 'Chanel Chance Eau Tendre EDP', nomeBase: 'Chanel Chance Eau Tendre', genero: 'F', conc: 'EDP', familia: 'Floral Frutal', nicho: false, preco: {'50ml': 205900, '100ml': 267200}, notas: 'Toranja, Quéssia, Almíscar Branco'  },
  'ysl black opium edp': { nome: 'YSL Black Opium EDP', nomeBase: 'YSL Black Opium', genero: 'F', conc: 'EDP', familia: 'Floral Gourmand', nicho: false, preco: {'30ml': 146200, '50ml': 177600, '90ml': 224800, '150ml': 283000}, notas: 'Café, Baunilha, Patchouli, Flor Branca'  },
  'ysl libre edp': { nome: 'YSL Libre EDP', nomeBase: 'YSL Libre', genero: 'F', conc: 'EDP', familia: 'Floral Amadeirado', nicho: false, preco: {'30ml': 149300, '50ml': 180800, '90ml': 227900}, notas: 'Lavanda, Flor de Laranjeira, Cedro'  },
  'ysl y edp': { nome: 'YSL Y EDP', nomeBase: 'YSL Y', genero: 'M', conc: 'EDP', familia: 'Fougère Amadeirado', nicho: false, preco: {'40ml': 125800, '60ml': 146200, '100ml': 172900, '200ml': 204400}, notas: 'Bergamota, Gengibre, Cedro'  },
  ...
  'armani acqua di giò edt': { nome: 'Armani Acqua di Giò EDT', nomeBase: 'Armani Acqua di Giò', genero: 'M', conc: 'EDT', familia: 'Aquático', nicho: false, preco: {'50ml': 149300, '100ml': 187100}, notas: 'Citrus, Alga Marinha, Patchouli'  },
  'armani acqua di giò edp': { nome: 'Armani Acqua di Giò EDP', nomeBase: 'Armani Acqua di Giò', genero: 'M', conc: 'EDP', familia: 'Aquático Aromático', nicho: false, preco: {'75ml': 193400, '125ml': 240500}, notas: 'Bergamota, Incenso, Patchouli'  },
  'armani acqua di giò profumo': { nome: 'Armani Acqua di Giò Profumo', nomeBase: 'Armani Acqua di Giò Profumo', genero: 'M', conc: 'Parfum', familia: 'Aquático Aromático', nicho: false, preco: {'75ml': 212200, '125ml': 262500}, notas: 'Incenso, Madeira, Cipreste'  },
  'armani sì edp': { nome: 'Armani Sì EDP', nomeBase: 'Armani Sì', genero: 'F', conc: 'EDP', familia: 'Floral Chypre', nicho: false, preco: {'30ml': 146200, '50ml': 176100, '100ml': 224800}, notas: 'Groselha, Rosa, Almíscar, Âmbar'  },
  'versace eros edt': { nome: 'Versace Eros EDT', nomeBase: 'Versace Eros', genero: 'M', conc: 'EDT', familia: 'Aromático Fougère', nicho: false, preco: {'50ml': 146200, '100ml': 183900}, notas: 'Menta, Tonka, Âmbar'  },
  'versace eros edp': { nome: 'Versace Eros EDP', nomeBase: 'Versace Eros', genero: 'M', conc: 'EDP', familia: 'Aromático Oriental', nicho: false, preco: {'50ml': 161900, '100ml': 204400}, notas: 'Bergamota, Néroli, Fava de Tonka'  },
  'lancôme la vie est belle edp': { nome: 'Lancôme La Vie est Belle EDP', nomeBase: 'Lancôme La Vie est Belle', genero: 'F', conc: 'EDP', familia: 'Floral Gourmand', nicho: false, preco: {'30ml': 128900, '50ml': 154100, '75ml': 168200, '100ml': 183900, '150ml': 209100, '200ml': 256200}, notas: 'Íris, Pralinê, Baunilha'  },
  'mugler angel edp': { nome: 'Mugler Angel EDP', nomeBase: 'Mugler Angel', genero: 'F', conc: 'EDP', familia: 'Oriental Gourmand', nicho: false, preco: {'25ml': 135200, '50ml': 172900, '100ml': 224800}, notas: 'Caramelo, Patchouli, Baunilha'  },
  'calvin klein ck one edt': { nome: 'Calvin Klein CK One EDT', nomeBase: 'Calvin Klein CK One', genero: 'U', conc: 'EDT', familia: 'Cítrico Aquático', nicho: false, preco: {'50ml': 108500, '100ml': 125800, '200ml': 146200}, notas: 'Bergamota, Chá Verde, Almíscar'  },
  ...
  'xerjoff 1861 naxos': { nome: 'Xerjoff 1861 Naxos EDP', nomeBase: 'Xerjoff 1861 Naxos', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 468300}, notas: 'Xerjoff' },
  ...
  'xerjoff torino21': { nome: 'Xerjoff Torino21 EDP', nomeBase: 'Xerjoff Torino21', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 553500}, notas: 'Xerjoff' },
  ...
  'xerjoff tony iommi monkey special': { nome: 'Xerjoff Tony Iommi Monkey Special EDP', nomeBase: 'Xerjoff Tony Iommi Monkey Special', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 723800}, notas: 'Xerjoff' },
  ...
  'xerjoff tony iommi deified': { nome: 'Xerjoff Tony Iommi Deified EDP', nomeBase: 'Xerjoff Tony Iommi Deified', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 519400}, notas: 'Xerjoff' },
  ...
  'tom ford cafe rose': { nome: 'Tom Ford Cafe Rose EDP', nomeBase: 'Tom Ford Cafe Rose', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: false, preco: {'100ml': 731000}, notas: 'Tom Ford' },
  ...
  // ===== NOVAS ENTRADAS — Excel Omnia =====
'serge lutens fils de joie': { nome: 'Serge Lutens Fils De Joie EDP', nomeBase: 'Serge Lutens Fils De Joie', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Fils De Joie' },
  'serge lutens dent de lait': { nome: 'Serge Lutens Dent De Lait EDP', nomeBase: 'Serge Lutens Dent De Lait', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 265700}, notas: 'Serge Lutens Dent De Lait' },
  'serge lutens la religieuse': { nome: 'Serge Lutens La Religieuse EDP', nomeBase: 'Serge Lutens La Religieuse', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens La Religieuse' },
  'serge lutens santal majuscule': { nome: 'Serge Lutens Santal Majuscule EDP', nomeBase: 'Serge Lutens Santal Majuscule', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Santal Majuscule' },
  'serge lutens five o clock au gingembre': { nome: 'Serge Lutens Five O\'clock Au Gingembre EDP', nomeBase: 'Serge Lutens Five O\'clock Au Gingembre', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Five O\'clock Au Gingembre' },
  'serge lutens nuit de cellophane': { nome: 'Serge Lutens Nuit De Cellophane EDP', nomeBase: 'Serge Lutens Nuit De Cellophane', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Nuit De Cellophane' },
  'serge lutens le fille de berlin': { nome: 'Serge Lutens Le Fille De Berlin EDP', nomeBase: 'Serge Lutens Le Fille De Berlin', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Le Fille De Berlin' },
  'serge lutens ambre sultan': { nome: 'Serge Lutens Ambre Sultan EDP', nomeBase: 'Serge Lutens Ambre Sultan', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Ambre Sultan' },
  'serge lutens leau': { nome: 'Serge Lutens L\'eau EDP', nomeBase: 'Serge Lutens L\'eau', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 323600}, notas: 'Serge Lutens L\'eau' },
  'serge lutens fèminité du bois': { nome: 'Serge Lutens Fèminité Du Bois EDP', nomeBase: 'Serge Lutens Fèminité Du Bois', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Fèminité Du Bois' },
  'serge lutens la fille tour de fer': { nome: 'Serge Lutens La Fille Tour De Fer EDP', nomeBase: 'Serge Lutens La Fille Tour De Fer', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens La Fille Tour De Fer' },
  'serge lutens écrin de fumée': { nome: 'Serge Lutens Écrin De Fumée EDP', nomeBase: 'Serge Lutens Écrin De Fumée', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Écrin De Fumée' },
  'serge lutens poivre noir': { nome: 'Serge Lutens Poivre Noir EDP', nomeBase: 'Serge Lutens Poivre Noir', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Poivre Noir' },
  'serge lutens la dompteuse encagée': { nome: 'Serge Lutens La Dompteuse Encagée EDP', nomeBase: 'Serge Lutens La Dompteuse Encagée', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens La Dompteuse Encagée' },
  'serge lutens fleurs doranger': { nome: 'Serge Lutens Fleurs D\'oranger EDP', nomeBase: 'Serge Lutens Fleurs D\'oranger', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Fleurs D\'oranger' },
  'serge lutens baptême du feu': { nome: 'Serge Lutens Baptême Du Feu EDP', nomeBase: 'Serge Lutens Baptême Du Feu', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 265700}, notas: 'Serge Lutens Baptême Du Feu' },
  'serge lutens un bois vanille': { nome: 'Serge Lutens Un Bois Vanille EDP', nomeBase: 'Serge Lutens Un Bois Vanille', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Un Bois Vanille' },
  'serge lutens le perce-vent': { nome: 'Serge Lutens Le Perce-vent EDP', nomeBase: 'Serge Lutens Le Perce-vent', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens Le Perce-vent' },
  'serge lutens lorpheline': { nome: 'Serge Lutens L\'orpheline EDP', nomeBase: 'Serge Lutens L\'orpheline', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 313400}, notas: 'Serge Lutens L\'orpheline' },
  'carthusia terra mia': { nome: 'Carthusia Terra Mia EDP', nomeBase: 'Carthusia Terra Mia', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Terra Mia' },
  'carthusia io capri': { nome: 'Carthusia Io Capri EDP', nomeBase: 'Carthusia Io Capri', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Io Capri' },
  'carthusia fiori di capri': { nome: 'Carthusia Fiori Di Capri EDP', nomeBase: 'Carthusia Fiori Di Capri', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Fiori Di Capri' },
  'carthusia essence of the park': { nome: 'Carthusia Essence Of The Park EDP', nomeBase: 'Carthusia Essence Of The Park', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Essence Of The Park' },
  'carthusia corallium': { nome: 'Carthusia Corallium EDP', nomeBase: 'Carthusia Corallium', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Corallium' },
  'carthusia aria di capri': { nome: 'Carthusia Aria Di Capri EDP', nomeBase: 'Carthusia Aria Di Capri', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Aria Di Capri' },
  'carthusia carthusia uomo': { nome: 'Carthusia Carthusia Uomo EDP', nomeBase: 'Carthusia Carthusia Uomo', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Carthusia Uomo' },
  'carthusia ammare': { nome: 'Carthusia A\'mmare EDP', nomeBase: 'Carthusia A\'mmare', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia A\'mmare' },
  'carthusia via camerelle': { nome: 'Carthusia Via Camerelle EDP', nomeBase: 'Carthusia Via Camerelle', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Via Camerelle' },
  'carthusia mediterraneo': { nome: 'Carthusia Mediterraneo EDP', nomeBase: 'Carthusia Mediterraneo', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Mediterraneo' },
  'carthusia 1681': { nome: 'Carthusia 1681 EDP', nomeBase: 'Carthusia 1681', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia 1681' },
  'carthusia numero uno': { nome: 'Carthusia Numero Uno EDP', nomeBase: 'Carthusia Numero Uno', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 312900}, notas: 'Carthusia Numero Uno' },
  'alexandre.j collector silver ombre': { nome: 'Alexandre.j Collector Silver Ombre EDP', nomeBase: 'Alexandre.j Collector Silver Ombre', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 277600}, notas: 'Alexandre.j Collector Silver Ombre' },
  'alexandre.j collector mandarine sultane': { nome: 'Alexandre.j Collector Mandarine Sultane EDP', nomeBase: 'Alexandre.j Collector Mandarine Sultane', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 277600}, notas: 'Alexandre.j Collector Mandarine Sultane' },
  'alexandre.j oscent white': { nome: 'Alexandre.j Oscent White EDP', nomeBase: 'Alexandre.j Oscent White', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 292900}, notas: 'Alexandre.j Oscent White' },
  'alexandre.j the majestic musk': { nome: 'Alexandre.j The Majestic Musk EDP', nomeBase: 'Alexandre.j The Majestic Musk', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 303100}, notas: 'Alexandre.j The Majestic Musk' },
  'alexandre.j the majestic jardin': { nome: 'Alexandre.j The Majestic Jardin EDP', nomeBase: 'Alexandre.j The Majestic Jardin', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 303100}, notas: 'Alexandre.j The Majestic Jardin' },
  'alexandre.j the majestic vanilla': { nome: 'Alexandre.j The Majestic Vanilla EDP', nomeBase: 'Alexandre.j The Majestic Vanilla', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 303100}, notas: 'Alexandre.j The Majestic Vanilla' },
  'moncler recharge pour homme': { nome: 'Moncler Recharge Pour Homme EDP', nomeBase: 'Moncler Recharge Pour Homme', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 227900}, notas: 'Moncler Recharge Pour Homme' },
  'moncler pour home led': { nome: 'Moncler Pour Home Led EDP', nomeBase: 'Moncler Pour Home Led', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 342700}, notas: 'Moncler Pour Home Led' },
  'moncler pour femme': { nome: 'Moncler Pour Femme EDP', nomeBase: 'Moncler Pour Femme', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 149300}, notas: 'Moncler Pour Femme' },
  'moncler pour femme led': { nome: 'Moncler Pour Femme Led EDP', nomeBase: 'Moncler Pour Femme Led', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 342700}, notas: 'Moncler Pour Femme Led' },
  'moncler sunrise pour femme': { nome: 'Moncler Sunrise Pour Femme EDP', nomeBase: 'Moncler Sunrise Pour Femme', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 149300}, notas: 'Moncler Sunrise Pour Femme' },
  'the merchant of venice byzantium saffron': { nome: 'The Merchant Of Venice Byzantium Saffron EDP', nomeBase: 'The Merchant Of Venice Byzantium Saffron', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 315100}, notas: 'The Merchant Of Venice Byzantium Saffron' },
  'the merchant of venice rosa moceniga elixir': { nome: 'The Merchant Of Venice Rosa Moceniga Elixir EDP', nomeBase: 'The Merchant Of Venice Rosa Moceniga Elixir', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'The Merchant Of Venice Rosa Moceniga Elixir' },
  'the merchant of venice maria callas': { nome: 'The Merchant Of Venice Maria Callas EDP', nomeBase: 'The Merchant Of Venice Maria Callas', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'The Merchant Of Venice Maria Callas' },
  'the merchant of venice flamant rose': { nome: 'The Merchant Of Venice Flamant Rose EDP', nomeBase: 'The Merchant Of Venice Flamant Rose', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 545000}, notas: 'The Merchant Of Venice Flamant Rose' },
  'the merchant of venice imperial emerald concentree': { nome: 'The Merchant Of Venice Imperial Emerald Concentree EDP', nomeBase: 'The Merchant Of Venice Imperial Emerald Concentree', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 545000}, notas: 'The Merchant Of Venice Imperial Emerald Concentree' },
  'the merchant of venice la fenice my pearls': { nome: 'The Merchant Of Venice La Fenice My Pearls EDP', nomeBase: 'The Merchant Of Venice La Fenice My Pearls', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'The Merchant Of Venice La Fenice My Pearls' },
  'the merchant of venice tmov venezia & oriente moscado': { nome: 'The Merchant Of Venice Tmov Venezia & Oriente Moscado EDP', nomeBase: 'The Merchant Of Venice Tmov Venezia & Oriente Moscado', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'The Merchant Of Venice Tmov Venezia & Oriente Moscado' },
  'the merchant of venice red potion': { nome: 'The Merchant Of Venice Red Potion EDP', nomeBase: 'The Merchant Of Venice Red Potion', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'The Merchant Of Venice Red Potion' },
  'the merchant of venice oriente blue tea': { nome: 'The Merchant Of Venice Oriente Blue Tea EDP', nomeBase: 'The Merchant Of Venice Oriente Blue Tea', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'The Merchant Of Venice Oriente Blue Tea' },
  'the merchant of venice oriente gyokuro': { nome: 'The Merchant Of Venice Oriente Gyokuro EDP', nomeBase: 'The Merchant Of Venice Oriente Gyokuro', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'The Merchant Of Venice Oriente Gyokuro' },
  'the merchant of venice cyprus shell': { nome: 'The Merchant Of Venice Cyprus Shell EDP', nomeBase: 'The Merchant Of Venice Cyprus Shell', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 229900}, notas: 'The Merchant Of Venice Cyprus Shell' },
  'trussardi galleria vittorio emanuele': { nome: 'Trussardi Galleria Vittorio Emanuele EDP', nomeBase: 'Trussardi Galleria Vittorio Emanuele', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 322300}, notas: 'Trussardi Galleria Vittorio Emanuele' },
  'trussardi walking in porta venezia': { nome: 'Trussardi Walking In Porta Venezia EDP', nomeBase: 'Trussardi Walking In Porta Venezia', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Trussardi Walking In Porta Venezia' },
  'trussardi alba sui navigli': { nome: 'Trussardi Alba Sui Navigli EDP', nomeBase: 'Trussardi Alba Sui Navigli', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Trussardi Alba Sui Navigli' },
  'trussardi porta nuova': { nome: 'Trussardi Porta Nuova EDP', nomeBase: 'Trussardi Porta Nuova', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 322300}, notas: 'Trussardi Porta Nuova' },
  'trussardi piazza alla scala': { nome: 'Trussardi Piazza Alla Scala EDP', nomeBase: 'Trussardi Piazza Alla Scala', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 322300}, notas: 'Trussardi Piazza Alla Scala' },
  'trussardi district of nolo': { nome: 'Trussardi District Of Nolo EDP', nomeBase: 'Trussardi District Of Nolo', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 322300}, notas: 'Trussardi District Of Nolo' },
  'trussardi via della spiga': { nome: 'Trussardi Via Della Spiga EDP', nomeBase: 'Trussardi Via Della Spiga', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 322300}, notas: 'Trussardi Via Della Spiga' },
  'trussardi musc noir perfume enhancer': { nome: 'Trussardi Musc Noir Perfume Enhancer EDP', nomeBase: 'Trussardi Musc Noir Perfume Enhancer', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Trussardi Musc Noir Perfume Enhancer' },
  'trussardi via fiori chiari': { nome: 'Trussardi Via Fiori Chiari EDP', nomeBase: 'Trussardi Via Fiori Chiari', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'100ml': 322300}, notas: 'Trussardi Via Fiori Chiari' },
  'reminiscence le patchouli elixir': { nome: 'Reminiscence Le Patchouli Elixir EDP', nomeBase: 'Reminiscence Le Patchouli Elixir', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 201000}, notas: 'Reminiscence Le Patchouli Elixir' },
  'reminiscence dolce riviera patchouli blanc': { nome: 'Reminiscence Dolce Riviera Patchouli Blanc EDP', nomeBase: 'Reminiscence Dolce Riviera Patchouli Blanc', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 201000}, notas: 'Reminiscence Dolce Riviera Patchouli Blanc' },
  'reminiscence sous un mimosa de provence': { nome: 'Reminiscence Sous Un Mimosa De Provence EDP', nomeBase: 'Reminiscence Sous Un Mimosa De Provence', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 182200}, notas: 'Reminiscence Sous Un Mimosa De Provence' },
  'reminiscence le rem': { nome: 'Reminiscence Le Rem EDP', nomeBase: 'Reminiscence Le Rem', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 182200}, notas: 'Reminiscence Le Rem' },
  'reminiscence le patchouli': { nome: 'Reminiscence Le Patchouli EDP', nomeBase: 'Reminiscence Le Patchouli', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 182200}, notas: 'Reminiscence Le Patchouli' },
  'obvious une figue': { nome: 'Obvious Une Figue EDP', nomeBase: 'Obvious Une Figue', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 238400}, notas: 'Obvious Une Figue' },
  'obvious un eté': { nome: 'Obvious Un Eté EDP', nomeBase: 'Obvious Un Eté', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 238400}, notas: 'Obvious Un Eté' },
  'obvious un patchouli': { nome: 'Obvious Un Patchouli EDP', nomeBase: 'Obvious Un Patchouli', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 238400}, notas: 'Obvious Un Patchouli' },
  'obvious un musc': { nome: 'Obvious Un Musc EDP', nomeBase: 'Obvious Un Musc', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 238400}, notas: 'Obvious Un Musc' },
  'lalique noir premier or intemporel 1888': { nome: 'Lalique Noir Premier Or Intemporel 1888 EDP', nomeBase: 'Lalique Noir Premier Or Intemporel 1888', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 527900}, notas: 'Lalique Noir Premier Or Intemporel 1888' },
  'gisada luxury magenta': { nome: 'Gisada Luxury Magenta EDP', nomeBase: 'Gisada Luxury Magenta', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'75ml': 416600}, notas: 'Gisada Luxury Magenta' },
  'gisada luxury madagascar': { nome: 'Gisada Luxury Madagascar EDP', nomeBase: 'Gisada Luxury Madagascar', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'75ml': 416600}, notas: 'Gisada Luxury Madagascar' },
  'gisada luxury fata morgana': { nome: 'Gisada Luxury Fata Morgana EDP', nomeBase: 'Gisada Luxury Fata Morgana', genero: 'U', conc: 'EDP', familia: 'Designer', nicho: false, preco: {'75ml': 416600}, notas: 'Gisada Luxury Fata Morgana' },
  'xerjoff 1861 naxos': { nome: 'Xerjoff 1861 Naxos EDP', nomeBase: 'Xerjoff 1861 Naxos', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 468300}, notas: 'Xerjoff 1861 Naxos' },
  'liquides imaginaires blanche bete': { nome: 'Liquides Imaginaires Blanche Bete EDP', nomeBase: 'Liquides Imaginaires Blanche Bete', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 390000}, notas: 'Liquides Imaginaires Blanche Bete' },
  'amouage jubilation xxv man': { nome: 'Amouage Jubilation Xxv Man EDP', nomeBase: 'Amouage Jubilation Xxv Man', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 672700}, notas: 'Amouage Jubilation Xxv Man' },
  'amouage love delight woman': { nome: 'Amouage Love Delight Woman EDP', nomeBase: 'Amouage Love Delight Woman', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 672700}, notas: 'Amouage Love Delight Woman' },
  'xerjoff torino21': { nome: 'Xerjoff Torino21 EDP', nomeBase: 'Xerjoff Torino21', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 553500}, notas: 'Xerjoff Torino21' },
  'parfums de marly haltane': { nome: 'Parfums De Marly Haltane EDP', nomeBase: 'Parfums De Marly Haltane', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'125ml': 604600}, notas: 'Parfums De Marly Haltane' },
  'orto parisi megamare': { nome: 'Orto Parisi Megamare EDP', nomeBase: 'Orto Parisi Megamare', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 315100}, notas: 'Orto Parisi Megamare' },
  'amouage interlude black iris man': { nome: 'Amouage Interlude Black Iris Man EDP', nomeBase: 'Amouage Interlude Black Iris Man', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 672700}, notas: 'Amouage Interlude Black Iris Man' },
  'xerjoff tony iommi monkey special': { nome: 'Xerjoff Tony Iommi Monkey Special EDP', nomeBase: 'Xerjoff Tony Iommi Monkey Special', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 723800}, notas: 'Xerjoff Tony Iommi Monkey Special' },
  'liquides imaginaires liquide gold': { nome: 'Liquides Imaginaires Liquide Gold EDP', nomeBase: 'Liquides Imaginaires Liquide Gold', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 355900}, notas: 'Liquides Imaginaires Liquide Gold' },
  'james heeley sel marin': { nome: 'James Heeley Sel Marin EDP', nomeBase: 'James Heeley Sel Marin', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 298000}, notas: 'James Heeley Sel Marin' },
  'ormonde jayne ormonde woman': { nome: 'Ormonde Jayne Ormonde Woman EDP', nomeBase: 'Ormonde Jayne Ormonde Woman', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'120ml': 417200}, notas: 'Ormonde Jayne Ormonde Woman' },
  'argos fragrances danaë': { nome: 'Argos Fragrances Danaë EDP', nomeBase: 'Argos Fragrances Danaë', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'Argos Fragrances Danaë' },
  'imaginary authors memoirs of a trespasser': { nome: 'Imaginary Authors Memoirs Of A Trespasser EDP', nomeBase: 'Imaginary Authors Memoirs Of A Trespasser', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 236600}, notas: 'Imaginary Authors Memoirs Of A Trespasser' },
  'marc-antoine barrois ganymede': { nome: 'Marc-antoine Barrois Ganymede EDP', nomeBase: 'Marc-antoine Barrois Ganymede', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'30ml': 255400}, notas: 'Marc-antoine Barrois Ganymede' },
  'essential parfums divine vanille': { nome: 'Essential Parfums Divine Vanille EDP', nomeBase: 'Essential Parfums Divine Vanille', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 196800}, notas: 'Essential Parfums Divine Vanille' },
  'initio parfums privés absolute aphrodisiac': { nome: 'Initio Parfums Privés Absolute Aphrodisiac EDP', nomeBase: 'Initio Parfums Privés Absolute Aphrodisiac', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'90ml': 510900}, notas: 'Initio Parfums Privés Absolute Aphrodisiac' },
  'initio parfums privés narcotic delight': { nome: 'Initio Parfums Privés Narcotic Delight EDP', nomeBase: 'Initio Parfums Privés Narcotic Delight', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'90ml': 510900}, notas: 'Initio Parfums Privés Narcotic Delight' },
  'liquides imaginaires desert suave': { nome: 'Liquides Imaginaires Desert Suave EDP', nomeBase: 'Liquides Imaginaires Desert Suave', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 287800}, notas: 'Liquides Imaginaires Desert Suave' },
  'argos fragrances fall of phaeton': { nome: 'Argos Fragrances Fall Of Phaeton EDP', nomeBase: 'Argos Fragrances Fall Of Phaeton', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'30ml': 349100}, notas: 'Argos Fragrances Fall Of Phaeton' },
  'trussardi passeggiata galleria vittorio ii': { nome: 'Trussardi Passeggiata Galleria Vittorio Ii EDP', nomeBase: 'Trussardi Passeggiata Galleria Vittorio Ii', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 373000}, notas: 'Trussardi Passeggiata Galleria Vittorio Ii' },
  'clive christian crab apple blossom': { nome: 'Clive Christian Crab Apple Blossom EDP', nomeBase: 'Clive Christian Crab Apple Blossom', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 817400}, notas: 'Clive Christian Crab Apple Blossom' },
  'liquides imaginaires dom rosa': { nome: 'Liquides Imaginaires Dom Rosa EDP', nomeBase: 'Liquides Imaginaires Dom Rosa', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 287800}, notas: 'Liquides Imaginaires Dom Rosa' },
  'argos fragrances adonis awakens': { nome: 'Argos Fragrances Adonis Awakens EDP', nomeBase: 'Argos Fragrances Adonis Awakens', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 401900}, notas: 'Argos Fragrances Adonis Awakens' },
  'by kilian apple brandy on the rocks': { nome: 'By Kilian Apple Brandy On The Rocks EDP', nomeBase: 'By Kilian Apple Brandy On The Rocks', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 468300}, notas: 'By Kilian Apple Brandy On The Rocks' },
  'gritti gossip night': { nome: 'Gritti Gossip Night EDP', nomeBase: 'Gritti Gossip Night', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 383200}, notas: 'Gritti Gossip Night' },
  'rosendo mateu rosendo mateu no.7': { nome: 'Rosendo Mateu Rosendo Mateu No.7 EDP', nomeBase: 'Rosendo Mateu Rosendo Mateu No.7', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Rosendo Mateu Rosendo Mateu No.7' },
  'xerjoff tony iommi deified': { nome: 'Xerjoff Tony Iommi Deified EDP', nomeBase: 'Xerjoff Tony Iommi Deified', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 519400}, notas: 'Xerjoff Tony Iommi Deified' },
  'initio parfums privés blessed baraka': { nome: 'Initio Parfums Privés Blessed Baraka EDP', nomeBase: 'Initio Parfums Privés Blessed Baraka', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'90ml': 510900}, notas: 'Initio Parfums Privés Blessed Baraka' },
  'nobile 1942 la danza delle libellule': { nome: 'Nobile 1942 La Danza Delle Libellule EDP', nomeBase: 'Nobile 1942 La Danza Delle Libellule', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 272500}, notas: 'Nobile 1942 La Danza Delle Libellule' },
  'goldfield & banks silky woods': { nome: 'Goldfield & Banks Silky Woods EDP', nomeBase: 'Goldfield & Banks Silky Woods', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 456400}, notas: 'Goldfield & Banks Silky Woods' },
  'atelier des ors blue madeleine': { nome: 'Atelier Des Ors Blue Madeleine EDP', nomeBase: 'Atelier Des Ors Blue Madeleine', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 442800}, notas: 'Atelier Des Ors Blue Madeleine' },
  'masque milano lost alice': { nome: 'Masque Milano Lost Alice EDP', nomeBase: 'Masque Milano Lost Alice', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 681200}, notas: 'Masque Milano Lost Alice' },
  'matiere premiere french flower': { nome: 'Matiere Premiere French Flower EDP', nomeBase: 'Matiere Premiere French Flower', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 332100}, notas: 'Matiere Premiere French Flower' },
  'rosendo mateu rosendo mateu no.6': { nome: 'Rosendo Mateu Rosendo Mateu No.6 EDP', nomeBase: 'Rosendo Mateu Rosendo Mateu No.6', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Rosendo Mateu Rosendo Mateu No.6' },
  'juliette has a gun not a perfume': { nome: 'Juliette Has A Gun Not A Perfume EDP', nomeBase: 'Juliette Has A Gun Not A Perfume', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 168600}, notas: 'Juliette Has A Gun Not A Perfume' },
  'by kilian moonlight in heaven': { nome: 'By Kilian Moonlight In Heaven EDP', nomeBase: 'By Kilian Moonlight In Heaven', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 493900}, notas: 'By Kilian Moonlight In Heaven' },
  'liquides imaginaires fortis': { nome: 'Liquides Imaginaires Fortis EDP', nomeBase: 'Liquides Imaginaires Fortis', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 287800}, notas: 'Liquides Imaginaires Fortis' },
  'nobile 1942 cafe chantant': { nome: 'Nobile 1942 Cafe Chantant EDP', nomeBase: 'Nobile 1942 Cafe Chantant', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 272500}, notas: 'Nobile 1942 Cafe Chantant' },
  'by kilian love dont be shy extreme': { nome: 'By Kilian Love Dont Be Shy Extreme EDP', nomeBase: 'By Kilian Love Dont Be Shy Extreme', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 587500}, notas: 'By Kilian Love Dont Be Shy Extreme' },
  'clive christian x masculine': { nome: 'Clive Christian X Masculine EDP', nomeBase: 'Clive Christian X Masculine', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 647100}, notas: 'Clive Christian X Masculine' },
  'argos fragrances sacred flame': { nome: 'Argos Fragrances Sacred Flame EDP', nomeBase: 'Argos Fragrances Sacred Flame', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 424000}, notas: 'Argos Fragrances Sacred Flame' },
  'bdk parfums villa neroli': { nome: 'Bdk Parfums Villa Neroli EDP', nomeBase: 'Bdk Parfums Villa Neroli', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 400200}, notas: 'Bdk Parfums Villa Neroli' },
  'bdk parfums citrus riviera': { nome: 'Bdk Parfums Citrus Riviera EDP', nomeBase: 'Bdk Parfums Citrus Riviera', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 400200}, notas: 'Bdk Parfums Citrus Riviera' },
  'akro bake': { nome: 'Akro Bake EDP', nomeBase: 'Akro Bake', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 264000}, notas: 'Akro Bake' },
  'penhaligons the tragedy of lord george': { nome: 'Penhaligon\'s The Tragedy Of Lord George EDP', nomeBase: 'Penhaligon\'s The Tragedy Of Lord George', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 493900}, notas: 'Penhaligon\'s The Tragedy Of Lord George' },
  'essential parfums fig infusion': { nome: 'Essential Parfums Fig Infusion EDP', nomeBase: 'Essential Parfums Fig Infusion', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 196800}, notas: 'Essential Parfums Fig Infusion' },
  'matiere premiere cologne cedrat': { nome: 'Matiere Premiere Cologne Cedrat EDP', nomeBase: 'Matiere Premiere Cologne Cedrat', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 373000}, notas: 'Matiere Premiere Cologne Cedrat' },
  'papillon artisan salome': { nome: 'Papillon Artisan Salome EDP', nomeBase: 'Papillon Artisan Salome', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 338900}, notas: 'Papillon Artisan Salome' },
  'liquides imaginaires dom rosa millesime': { nome: 'Liquides Imaginaires Dom Rosa Millesime EDP', nomeBase: 'Liquides Imaginaires Dom Rosa Millesime', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 373000}, notas: 'Liquides Imaginaires Dom Rosa Millesime' },
  'initio parfums privés high frequency': { nome: 'Initio Parfums Privés High Frequency EDP', nomeBase: 'Initio Parfums Privés High Frequency', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'90ml': 510900}, notas: 'Initio Parfums Privés High Frequency' },
  'orto parisi seminalis': { nome: 'Orto Parisi Seminalis EDP', nomeBase: 'Orto Parisi Seminalis', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 315100}, notas: 'Orto Parisi Seminalis' },
  'atelier des ors riviera sunrise': { nome: 'Atelier Des Ors Riviera Sunrise EDP', nomeBase: 'Atelier Des Ors Riviera Sunrise', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 391700}, notas: 'Atelier Des Ors Riviera Sunrise' },
  'miller harris tea tonique': { nome: 'Miller Harris Tea Tonique EDP', nomeBase: 'Miller Harris Tea Tonique', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 272500}, notas: 'Miller Harris Tea Tonique' },
  'marc-antoine barrois b683': { nome: 'Marc-antoine Barrois B683 EDP', nomeBase: 'Marc-antoine Barrois B683', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 391700}, notas: 'Marc-antoine Barrois B683' },
  'ormonde jayne tolu': { nome: 'Ormonde Jayne Tolu EDP', nomeBase: 'Ormonde Jayne Tolu', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'120ml': 417200}, notas: 'Ormonde Jayne Tolu' },
  'liquides imaginaires sancti': { nome: 'Liquides Imaginaires Sancti EDP', nomeBase: 'Liquides Imaginaires Sancti', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 408700}, notas: 'Liquides Imaginaires Sancti' },
  'clive christian queen anne rock rose': { nome: 'Clive Christian Queen Anne Rock Rose EDP', nomeBase: 'Clive Christian Queen Anne Rock Rose', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 987700}, notas: 'Clive Christian Queen Anne Rock Rose' },
  'bdk parfums bouquet de hongrie': { nome: 'Bdk Parfums Bouquet De Hongrie EDP', nomeBase: 'Bdk Parfums Bouquet De Hongrie', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 400200}, notas: 'Bdk Parfums Bouquet De Hongrie' },
  'kajal perfumes almaz': { nome: 'Kajal Perfumes Almaz EDP', nomeBase: 'Kajal Perfumes Almaz', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 442800}, notas: 'Kajal Perfumes Almaz' },
  'widian widian london': { nome: 'Widian Widian London EDP', nomeBase: 'Widian Widian London', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 613100}, notas: 'Widian Widian London' },
  'liquides imaginaires beaute du diable': { nome: 'Liquides Imaginaires Beaute Du Diable EDP', nomeBase: 'Liquides Imaginaires Beaute Du Diable', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 502400}, notas: 'Liquides Imaginaires Beaute Du Diable' },
  'room 1015 sweet leaf': { nome: 'Room 1015 Sweet Leaf EDP', nomeBase: 'Room 1015 Sweet Leaf', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 219700}, notas: 'Room 1015 Sweet Leaf' },
  'nobile 1942 malia': { nome: 'Nobile 1942 Malia EDP', nomeBase: 'Nobile 1942 Malia', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 400200}, notas: 'Nobile 1942 Malia' },
  'marc-antoine barrois encelade': { nome: 'Marc-antoine Barrois Encelade EDP', nomeBase: 'Marc-antoine Barrois Encelade', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 366100}, notas: 'Marc-antoine Barrois Encelade' },
  'frederic malle french lover': { nome: 'Frederic Malle French Lover EDP', nomeBase: 'Frederic Malle French Lover', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 570500}, notas: 'Frederic Malle French Lover' },
  'tom ford cafe rose': { nome: 'Tom Ford Cafe Rose EDP', nomeBase: 'Tom Ford Cafe Rose', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 417200}, notas: 'Tom Ford Cafe Rose' },
  'bois 1920 sushi imperiale': { nome: 'Bois 1920 Sushi Imperiale EDP', nomeBase: 'Bois 1920 Sushi Imperiale', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 332100}, notas: 'Bois 1920 Sushi Imperiale' },
  'by kilian straight to heaven': { nome: 'By Kilian Straight To Heaven EDP', nomeBase: 'By Kilian Straight To Heaven', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 493900}, notas: 'By Kilian Straight To Heaven' },
  'miller harris peau santal': { nome: 'Miller Harris Peau Santal EDP', nomeBase: 'Miller Harris Peau Santal', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 349100}, notas: 'Miller Harris Peau Santal' },
  'liquides imaginaires ile pourpre': { nome: 'Liquides Imaginaires Ile Pourpre EDP', nomeBase: 'Liquides Imaginaires Ile Pourpre', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 281000}, notas: 'Liquides Imaginaires Ile Pourpre' },
  'nobile 1942 shamal': { nome: 'Nobile 1942 Shamal EDP', nomeBase: 'Nobile 1942 Shamal', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 400200}, notas: 'Nobile 1942 Shamal' },
  'frederic malle carnal flower': { nome: 'Frederic Malle Carnal Flower EDP', nomeBase: 'Frederic Malle Carnal Flower', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 638600}, notas: 'Frederic Malle Carnal Flower' },
  'borntostandout drunk lovers': { nome: 'Borntostandout Drunk Lovers EDP', nomeBase: 'Borntostandout Drunk Lovers', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 407000}, notas: 'Borntostandout Drunk Lovers' },
  'bdk parfums nuit de sable': { nome: 'Bdk Parfums Nuit De Sable EDP', nomeBase: 'Bdk Parfums Nuit De Sable', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 400200}, notas: 'Bdk Parfums Nuit De Sable' },
  'frederic malle en passant': { nome: 'Frederic Malle En Passant EDP', nomeBase: 'Frederic Malle En Passant', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 570500}, notas: 'Frederic Malle En Passant' },
  'rosendo mateu rosendo mateu no.3': { nome: 'Rosendo Mateu Rosendo Mateu No.3 EDP', nomeBase: 'Rosendo Mateu Rosendo Mateu No.3', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Rosendo Mateu Rosendo Mateu No.3' },
  'bohoboco sea salt caramel': { nome: 'Bohoboco Sea Salt Caramel EDP', nomeBase: 'Bohoboco Sea Salt Caramel', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 332100}, notas: 'Bohoboco Sea Salt Caramel' },
  'imaginary authors untamable': { nome: 'Imaginary Authors Untamable EDP', nomeBase: 'Imaginary Authors Untamable', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 236600}, notas: 'Imaginary Authors Untamable' },
  'bdk parfums sel dargent': { nome: 'Bdk Parfums Sel D\'argent EDP', nomeBase: 'Bdk Parfums Sel D\'argent', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 400200}, notas: 'Bdk Parfums Sel D\'argent' },
  '27 87 elixir de bombe': { nome: '27 87 Elixir De Bombe EDP', nomeBase: '27 87 Elixir De Bombe', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'87ml': 366100}, notas: '27 87 Elixir De Bombe' },
  'orto parisi brutus': { nome: 'Orto Parisi Brutus EDP', nomeBase: 'Orto Parisi Brutus', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 315100}, notas: 'Orto Parisi Brutus' },
  'marc-antoine barrois aldebaran': { nome: 'Marc-antoine Barrois Aldebaran EDP', nomeBase: 'Marc-antoine Barrois Aldebaran', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 366100}, notas: 'Marc-antoine Barrois Aldebaran' },
  'frederic malle rose tonnerre': { nome: 'Frederic Malle Rose Tonnerre EDP', nomeBase: 'Frederic Malle Rose Tonnerre', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 638600}, notas: 'Frederic Malle Rose Tonnerre' },
  'rosendo mateu rosendo mateu no.4': { nome: 'Rosendo Mateu Rosendo Mateu No.4 EDP', nomeBase: 'Rosendo Mateu Rosendo Mateu No.4', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Rosendo Mateu Rosendo Mateu No.4' },
  'argos fragrances la primavera': { nome: 'Argos Fragrances La Primavera EDP', nomeBase: 'Argos Fragrances La Primavera', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 390000}, notas: 'Argos Fragrances La Primavera' },
  'by kilian intoxicated': { nome: 'By Kilian Intoxicated EDP', nomeBase: 'By Kilian Intoxicated', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 493900}, notas: 'By Kilian Intoxicated' },
  'acca kappa muschio bianco (white moss)': { nome: 'Acca Kappa Muschio Bianco (white Moss) EDP', nomeBase: 'Acca Kappa Muschio Bianco (white Moss)', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 264000}, notas: 'Acca Kappa Muschio Bianco (white Moss)' },
  'essential parfums orange x santal': { nome: 'Essential Parfums Orange X Santal EDP', nomeBase: 'Essential Parfums Orange X Santal', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 201000}, notas: 'Essential Parfums Orange X Santal' },
  'liquides imaginaires fleur de sable': { nome: 'Liquides Imaginaires Fleur De Sable EDP', nomeBase: 'Liquides Imaginaires Fleur De Sable', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 281000}, notas: 'Liquides Imaginaires Fleur De Sable' },
  'frederic malle music for a while': { nome: 'Frederic Malle Music For A While EDP', nomeBase: 'Frederic Malle Music For A While', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 570500}, notas: 'Frederic Malle Music For A While' },
  'miller harris la feuille': { nome: 'Miller Harris La Feuille EDP', nomeBase: 'Miller Harris La Feuille', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 434300}, notas: 'Miller Harris La Feuille' },
  'creed creed aventus': { nome: 'Creed Creed Aventus EDP', nomeBase: 'Creed Creed Aventus', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 519400}, notas: 'Creed Creed Aventus' },
  'bohoboco red wine brown sugar': { nome: 'Bohoboco Red Wine Brown Sugar EDP', nomeBase: 'Bohoboco Red Wine Brown Sugar', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 332100}, notas: 'Bohoboco Red Wine Brown Sugar' },
  'rosendo mateu rosendo mateu no.2': { nome: 'Rosendo Mateu Rosendo Mateu No.2 EDP', nomeBase: 'Rosendo Mateu Rosendo Mateu No.2', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Rosendo Mateu Rosendo Mateu No.2' },
  'nobile 1942 nobile 1942 1001': { nome: 'Nobile 1942 Nobile 1942 1001 EDP', nomeBase: 'Nobile 1942 Nobile 1942 1001', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 264000}, notas: 'Nobile 1942 Nobile 1942 1001' },
  'ormonde jayne verano': { nome: 'Ormonde Jayne Verano EDP', nomeBase: 'Ormonde Jayne Verano', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'88ml': 434300}, notas: 'Ormonde Jayne Verano' },
  'goldfield & banks desert rosewood': { nome: 'Goldfield & Banks Desert Rosewood EDP', nomeBase: 'Goldfield & Banks Desert Rosewood', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 357600}, notas: 'Goldfield & Banks Desert Rosewood' },
  'goldfield & banks purple suede': { nome: 'Goldfield & Banks Purple Suede EDP', nomeBase: 'Goldfield & Banks Purple Suede', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 456400}, notas: 'Goldfield & Banks Purple Suede' },
  'moth and rabbit la haine no 5': { nome: 'Moth And Rabbit La Haine No 5 EDP', nomeBase: 'Moth And Rabbit La Haine No 5', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 298000}, notas: 'Moth And Rabbit La Haine No 5' },
  'miller harris poirier dun soir': { nome: 'Miller Harris Poirier D\'un Soir EDP', nomeBase: 'Miller Harris Poirier D\'un Soir', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 229900}, notas: 'Miller Harris Poirier D\'un Soir' },
  'nobile 1942 pontevecchio': { nome: 'Nobile 1942 Pontevecchio EDP', nomeBase: 'Nobile 1942 Pontevecchio', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 272500}, notas: 'Nobile 1942 Pontevecchio' },
  'penhaligons empressa': { nome: 'Penhaligon\'s Empressa EDP', nomeBase: 'Penhaligon\'s Empressa', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 459800}, notas: 'Penhaligon\'s Empressa' },
  'royal crown upper class': { nome: 'Royal Crown Upper Class EDP', nomeBase: 'Royal Crown Upper Class', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 965600}, notas: 'Royal Crown Upper Class' },
  'imaginary authors sundrunk': { nome: 'Imaginary Authors Sundrunk EDP', nomeBase: 'Imaginary Authors Sundrunk', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 236600}, notas: 'Imaginary Authors Sundrunk' },
  'ormonde jayne levant': { nome: 'Ormonde Jayne Levant EDP', nomeBase: 'Ormonde Jayne Levant', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'88ml': 383200}, notas: 'Ormonde Jayne Levant' },
  'orto parisi stercus': { nome: 'Orto Parisi Stercus EDP', nomeBase: 'Orto Parisi Stercus', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 315100}, notas: 'Orto Parisi Stercus' },
  'the different company sublime balkiss': { nome: 'The Different Company Sublime Balkiss EDP', nomeBase: 'The Different Company Sublime Balkiss', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 417200}, notas: 'The Different Company Sublime Balkiss' },
  'zarkoperfume cloud collection no.1': { nome: 'Zarkoperfume Cloud Collection No.1 EDP', nomeBase: 'Zarkoperfume Cloud Collection No.1', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 429200}, notas: 'Zarkoperfume Cloud Collection No.1' },
  '27 87 sonar': { nome: '27 87 Sonar EDP', nomeBase: '27 87 Sonar', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'87ml': 366100}, notas: '27 87 Sonar' },
  'by kilian back to black': { nome: 'By Kilian Back To Black EDP', nomeBase: 'By Kilian Back To Black', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 493900}, notas: 'By Kilian Back To Black' },
  'nobile 1942 anti malocchio': { nome: 'Nobile 1942 Anti Malocchio EDP', nomeBase: 'Nobile 1942 Anti Malocchio', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 212900}, notas: 'Nobile 1942 Anti Malocchio' },
  'liquides imaginaires buveur de vent': { nome: 'Liquides Imaginaires Buveur De Vent EDP', nomeBase: 'Liquides Imaginaires Buveur De Vent', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 408700}, notas: 'Liquides Imaginaires Buveur De Vent' },
  'diptyque l ombre dans l eau': { nome: 'Diptyque L\'ombre Dans L\'eau EDP', nomeBase: 'Diptyque L\'ombre Dans L\'eau', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 323600}, notas: 'Diptyque L\'ombre Dans L\'eau' },
  'clive christian x feminine': { nome: 'Clive Christian X Feminine EDP', nomeBase: 'Clive Christian X Feminine', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 647100}, notas: 'Clive Christian X Feminine' },
  'trussardi walking on via fiori oscuri': { nome: 'Trussardi Walking On Via Fiori Oscuri EDP', nomeBase: 'Trussardi Walking On Via Fiori Oscuri', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 373000}, notas: 'Trussardi Walking On Via Fiori Oscuri' },
  'orto parisi viride': { nome: 'Orto Parisi Viride EDP', nomeBase: 'Orto Parisi Viride', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 315100}, notas: 'Orto Parisi Viride' },
  'liquides imaginaires ame de fleur': { nome: 'Liquides Imaginaires Ame De Fleur EDP', nomeBase: 'Liquides Imaginaires Ame De Fleur', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 408700}, notas: 'Liquides Imaginaires Ame De Fleur' },
  'clive christian no1 masculine': { nome: 'Clive Christian No1 Masculine EDP', nomeBase: 'Clive Christian No1 Masculine', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 1328300}, notas: 'Clive Christian No1 Masculine' },
  'trussardi i via fiori chiari': { nome: 'Trussardi I Via Fiori Chiari EDP', nomeBase: 'Trussardi I Via Fiori Chiari', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 373000}, notas: 'Trussardi I Via Fiori Chiari' },
  'akro awake': { nome: 'Akro Awake EDP', nomeBase: 'Akro Awake', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 323600}, notas: 'Akro Awake' },
  'dusita fleur de lalita': { nome: 'Dusita Fleur De Lalita EDP', nomeBase: 'Dusita Fleur De Lalita', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 425800}, notas: 'Dusita Fleur De Lalita' },
  'liquides imaginaires phantasma': { nome: 'Liquides Imaginaires Phantasma EDP', nomeBase: 'Liquides Imaginaires Phantasma', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 408700}, notas: 'Liquides Imaginaires Phantasma' },
  'nobile 1942 patchouli nobile': { nome: 'Nobile 1942 Patchouli Nobile EDP', nomeBase: 'Nobile 1942 Patchouli Nobile', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 272500}, notas: 'Nobile 1942 Patchouli Nobile' },
  'bohoboco coffee white flowers': { nome: 'Bohoboco Coffee White Flowers EDP', nomeBase: 'Bohoboco Coffee White Flowers', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 332100}, notas: 'Bohoboco Coffee White Flowers' },
  'rosendo mateu rosendo mateu 1968': { nome: 'Rosendo Mateu Rosendo Mateu 1968 EDP', nomeBase: 'Rosendo Mateu Rosendo Mateu 1968', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 425800}, notas: 'Rosendo Mateu Rosendo Mateu 1968' },
  'rosendo mateu rosendo mateu 2010': { nome: 'Rosendo Mateu Rosendo Mateu 2010 EDP', nomeBase: 'Rosendo Mateu Rosendo Mateu 2010', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 425800}, notas: 'Rosendo Mateu Rosendo Mateu 2010' },
  'trussardi the street artists of isola': { nome: 'Trussardi The Street Artists Of Isola EDP', nomeBase: 'Trussardi The Street Artists Of Isola', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 373000}, notas: 'Trussardi The Street Artists Of Isola' },
  'floraiku between two trees': { nome: 'Floraiku Between Two Trees EDP', nomeBase: 'Floraiku Between Two Trees', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 553500}, notas: 'Floraiku Between Two Trees' },
  'acca kappa sakura tokyo': { nome: 'Acca Kappa Sakura Tokyo EDP', nomeBase: 'Acca Kappa Sakura Tokyo', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 264000}, notas: 'Acca Kappa Sakura Tokyo' },
  'lattafa asad zanzibar': { nome: 'Lattafa Asad Zanzibar EDP', nomeBase: 'Lattafa Asad Zanzibar', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 117500}, notas: 'Lattafa Asad Zanzibar' },
  'sospiro erba pura magica': { nome: 'Sospiro Erba Pura Magica EDP', nomeBase: 'Sospiro Erba Pura Magica', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 441100}, notas: 'Sospiro Erba Pura Magica' },
  'by kilian vodka on the rocks': { nome: 'By Kilian Vodka On The Rocks EDP', nomeBase: 'By Kilian Vodka On The Rocks', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 493900}, notas: 'By Kilian Vodka On The Rocks' },
  'by kilian good girl gone bad extreme': { nome: 'By Kilian Good Girl Gone Bad Extreme EDP', nomeBase: 'By Kilian Good Girl Gone Bad Extreme', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 587500}, notas: 'By Kilian Good Girl Gone Bad Extreme' },
  'guerlain linstant pour homme': { nome: 'Guerlain L\'instant Pour Homme EDP', nomeBase: 'Guerlain L\'instant Pour Homme', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 264000}, notas: 'Guerlain L\'instant Pour Homme' },
  'parfums de marly palatine': { nome: 'Parfums De Marly Palatine EDP', nomeBase: 'Parfums De Marly Palatine', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'75ml': 536400}, notas: 'Parfums De Marly Palatine' },
  'masque milano love kills': { nome: 'Masque Milano Love Kills EDP', nomeBase: 'Masque Milano Love Kills', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 681200}, notas: 'Masque Milano Love Kills' },
  'zarkoperfume cloud collection no.3 deep forest': { nome: 'Zarkoperfume Cloud Collection No.3 Deep Forest EDP', nomeBase: 'Zarkoperfume Cloud Collection No.3 Deep Forest', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 476800}, notas: 'Zarkoperfume Cloud Collection No.3 Deep Forest' },
  'trussardi behind the curtain piazza alla scala': { nome: 'Trussardi Behind The Curtain Piazza Alla Scala EDP', nomeBase: 'Trussardi Behind The Curtain Piazza Alla Scala', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 373000}, notas: 'Trussardi Behind The Curtain Piazza Alla Scala' },
  'akro smile': { nome: 'Akro Smile EDP', nomeBase: 'Akro Smile', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 264000}, notas: 'Akro Smile' },
  'parfums de marly galloway': { nome: 'Parfums De Marly Galloway EDP', nomeBase: 'Parfums De Marly Galloway', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'125ml': 545000}, notas: 'Parfums De Marly Galloway' },
  'maison crivelli musc nurāsana': { nome: 'Maison Crivelli Musc Nurāsana EDP', nomeBase: 'Maison Crivelli Musc Nurāsana', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 647100, '50ml': 391700, '5ml': 93700}, notas: 'Maison Crivelli Musc Nurāsana' },
  'maison crivelli cuir infrarouge': { nome: 'Maison Crivelli Cuir Infrarouge EDP', nomeBase: 'Maison Crivelli Cuir Infrarouge', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 647100, '50ml': 391700, '5ml': 93700}, notas: 'Maison Crivelli Cuir Infrarouge' },
  'maison crivelli safran secret': { nome: 'Maison Crivelli Safran Secret EDP', nomeBase: 'Maison Crivelli Safran Secret', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 681200, '50ml': 417200, '5ml': 102200}, notas: 'Maison Crivelli Safran Secret' },
  'maison crivelli oud maracujá': { nome: 'Maison Crivelli Oud Maracujá EDP', nomeBase: 'Maison Crivelli Oud Maracujá', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 681200, '50ml': 417200, '5ml': 102200}, notas: 'Maison Crivelli Oud Maracujá' },
  'maison crivelli oud cadenza': { nome: 'Maison Crivelli Oud Cadenza EDP', nomeBase: 'Maison Crivelli Oud Cadenza', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 681200, '50ml': 417200, '5ml': 102200}, notas: 'Maison Crivelli Oud Cadenza' },
  'maison crivelli oud stallion': { nome: 'Maison Crivelli Oud Stallion EDP', nomeBase: 'Maison Crivelli Oud Stallion', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 681200, '50ml': 417200, '5ml': 102200}, notas: 'Maison Crivelli Oud Stallion' },
  'maison crivelli hibiscus mahajád': { nome: 'Maison Crivelli Hibiscus Mahajád EDP', nomeBase: 'Maison Crivelli Hibiscus Mahajád', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 647100, '50ml': 391700, '5ml': 93700}, notas: 'Maison Crivelli Hibiscus Mahajád' },
  'maison crivelli tubéreuse astrale': { nome: 'Maison Crivelli Tubéreuse Astrale EDP', nomeBase: 'Maison Crivelli Tubéreuse Astrale', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 647100, '50ml': 391700, '5ml': 93700}, notas: 'Maison Crivelli Tubéreuse Astrale' },
  'maison crivelli ambre chromatique': { nome: 'Maison Crivelli Ambre Chromatique EDP', nomeBase: 'Maison Crivelli Ambre Chromatique', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 391700, '5ml': 93700}, notas: 'Maison Crivelli Ambre Chromatique' },
  'maison crivelli patchouli magnetik': { nome: 'Maison Crivelli Patchouli Magnetik EDP', nomeBase: 'Maison Crivelli Patchouli Magnetik', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'50ml': 391700, '5ml': 93700}, notas: 'Maison Crivelli Patchouli Magnetik' },
  'maison crivelli iris malikhân': { nome: 'Maison Crivelli Iris Malikhân EDP', nomeBase: 'Maison Crivelli Iris Malikhân', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Iris Malikhân' },
  'maison crivelli rose saltifolia': { nome: 'Maison Crivelli Rose Saltifolia EDP', nomeBase: 'Maison Crivelli Rose Saltifolia', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Rose Saltifolia' },
  'maison crivelli bois datchai': { nome: 'Maison Crivelli Bois Datchai EDP', nomeBase: 'Maison Crivelli Bois Datchai', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Bois Datchai' },
  'maison crivelli santal volcanique': { nome: 'Maison Crivelli Santal Volcanique EDP', nomeBase: 'Maison Crivelli Santal Volcanique', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Santal Volcanique' },
  'maison crivelli papyrus moléculaire': { nome: 'Maison Crivelli Papyrus Moléculaire EDP', nomeBase: 'Maison Crivelli Papyrus Moléculaire', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Papyrus Moléculaire' },
  'maison crivelli neroli nasimba': { nome: 'Maison Crivelli Neroli Nasimba EDP', nomeBase: 'Maison Crivelli Neroli Nasimba', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Neroli Nasimba' },
  'maison crivelli absinthe boréale': { nome: 'Maison Crivelli Absinthe Boréale EDP', nomeBase: 'Maison Crivelli Absinthe Boréale', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Absinthe Boréale' },
  'maison crivelli lys sølaberg': { nome: 'Maison Crivelli Lys Sølaberg EDP', nomeBase: 'Maison Crivelli Lys Sølaberg', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 374700}, notas: 'Maison Crivelli Lys Sølaberg' },
  'maison crivelli citrus batikanga': { nome: 'Maison Crivelli Citrus Batikanga EDP', nomeBase: 'Maison Crivelli Citrus Batikanga', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'100ml': 204400}, notas: 'Maison Crivelli Citrus Batikanga' },
  'maison crivelli coffret explor. extraits (6×5ml)': { nome: 'Maison Crivelli Coffret Explor. Extraits (6×5ml) EDP', nomeBase: 'Maison Crivelli Coffret Explor. Extraits (6×5ml)', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'5ml': 281000}, notas: 'Maison Crivelli Coffret Explor. Extraits (6×5ml)' },
  'maison crivelli coffret descoberta edp (8×1.5ml)': { nome: 'Maison Crivelli Coffret Descoberta Edp (8×1.5ml) EDP', nomeBase: 'Maison Crivelli Coffret Descoberta Edp (8×1.5ml)', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'5ml': 110700}, notas: 'Maison Crivelli Coffret Descoberta Edp (8×1.5ml)' },
  'maison crivelli coffret descoberta extraits': { nome: 'Maison Crivelli Coffret Descoberta Extraits EDP', nomeBase: 'Maison Crivelli Coffret Descoberta Extraits', genero: 'U', conc: 'EDP', familia: 'Nicho', nicho: true, preco: {'5ml': 120900}, notas: 'Maison Crivelli Coffret Descoberta Extraits' },
...
function getBotReply(from, msg) {
  ...
  // ================================================
  const MARCAS_LISTA = {
    'nishane': () => { const ps = [...new Set(Object.values(CATALOGO).filter(p => p.nomeBase.startsWith('Nishane')).map(p => p.nomeBase))]; return `✨ *Nishane — colecção disponível:*\n\n${ps.map(nb => { const vs = Object.values(CATALOGO).filter(p => p.nomeBase === nb); const kzMin = Math.min(...vs.map(p => precoMin(p.preco))); return `• *${nb}* _(${vs.map(p=>p.conc).join('/')})_ — a partir de ${kzMin.toLocaleString('pt-PT')} Kz`; }).join('\n')}\n\n_Escreva o nome completo para ver detalhes e preços._`; },
    'mancera': () => { const ps = [...new Set(Object.values(CATALOGO).filter(p => p.nomeBase.startsWith('Mancera')).map(p => p.nomeBase))]; return `✨ *Mancera — colecção disponível:*\n\n${ps.map(nb => { const vs = Object.values(CATALOGO).filter(p => p.nomeBase === nb); const kzMin = Math.min(...vs.map(p => precoMin(p.preco))); return `• *${nb}* — a partir de ${kzMin.toLocaleString('pt-PT')} Kz`; }).join('\n')}\n\n_Escreva o nome completo para ver detalhes e preços._`; },
    'montale': () => { const ps = [...new Set(Object.values(CATALOGO).filter(p => p.nomeBase.startsWith('Montale')).map(p => p.nomeBase))]; return `✨ *Montale — colecção disponível:*\n\n${ps.map(nb => { const vs = Object.values(CATALOGO).filter(p => p.nomeBase === nb); const kzMin = Math.min(...vs.map(p => precoMin(p.preco))); return `• *${nb}* — a partir de ${kzMin.toLocaleString('pt-PT')} Kz`; }).join('\n')}\n\n_Escreva o nome completo para ver detalhes e preços._`; },
    'creed': () => { const ps = [...new Set(Object.values(CATALOGO).filter(p => p.nomeBase.startsWith('Creed')).map(p => p.nomeBase))]; return `✨ *Creed — colecção disponível:*\n\n${ps.map(nb => { const vs = Object.values(CATALOGO).filter(p => p.nomeBase === nb); const kzMin = Math.min(...vs.map(p => precoMin(p.preco))); return `• *${nb}* — a partir de ${kzMin.toLocaleString('pt-PT')} Kz`; }).join('\n')}\n\n_Escreva o nome completo para ver detalhes e preços._`; },
    'parfums de marly': () => { const ps = [...new Set(Object.values(CATALOGO).filter(p => p.nomeBase.startsWith('Parfums de Marly')).map(p => p.nomeBase))]; return `✨ *Parfums de Marly — colecção disponível:*\n\n${ps.map(nb => { const vs = Object.values(CATALOGO).filter(p => p.nomeBase === nb); const kzMin = Math.min(...vs.map(p => precoMin(p.preco))); return `• *${nb}* — a partir de ${kzMin.toLocaleString('pt-PT')} Kz`; }).join('\n')}\n\n_Escreva o nome completo para ver detalhes e preços._`; },
    'amouage': () => { const ps = [...new Set(Object.values(CATALOGO).filter(p => p.nomeBase.startsWith('Amouage')).map(p => p.nomeBase))]; return `✨ *Amouage — colecção disponível:*\n\n${ps.map(nb => { const vs = Object.values(CATALOGO).filter(p => p.nomeBase === nb); const kzMin = Math.min(...vs.map(p => precoMin(p.preco))); return `• *${nb}* — a partir de ${kzMin.toLocaleString('pt-PT')} Kz`; }).join('\n')}\n\n_Escreva o nome completo para ver detalhes e preços._`; },
...
Indique o número da opção pretendida.`;
  ...
  // ================================================
  // P2A — Verificação de promoção (após upsell Nishane)
  // ================================================
  if (/^(promocao|promocao|promo|desconto|tem promocao|ha promocao|existe promocao)$/.test(txtNorm)) {
    const nomeActual = sessao?.nomeBase || '';
    if (nomeActual.startsWith('Nishane')) {
      const p = Object.values(CATALOGO).find(x => x.nomeBase === nomeActual);
      if (p) {
        const kzMin = precoMin(p.preco);
        const kzComDesc = Math.round(kzMin * 0.95 / 100) * 100;
        if (DESCONTO_SEMANA > 0) {
          return `Sim! Temos actualmente *${DESCONTO_SEMANA}% de desconto* activo. O ${nomeActual} fica a partir de *${Math.round(kzMin * (1 - DESCONTO_SEMANA/100) / 100) * 100} Kz* em vez de ${kzMin.toLocaleString('pt-PT')} Kz.\n\nDeseja encomendar?`;
        }
        return `De momento não temos promoção activa no ${nomeActual}. Os preços praticados já reflectem a melhor relação qualidade-valor para este nível de exclusividade.\n\nDeseja avançar com a encomenda?`;
      }
    }
    if (DESCONTO_SEMANA > 0) {
      return `Sim! Temos *${DESCONTO_SEMANA}% de desconto* em toda a colecção esta semana. Escreva o nome do perfume para ver o preço com desconto.`;
    }
    return `De momento não temos promoções activas. Os preços praticados já reflectem a melhor relação qualidade-valor da nossa selecção.`;
  }

  // ================================================
  // P2B — Correcção de categoria pelo cliente
  // Ex: "Tom Ford não é nicho", "isso não é nicho"
  // ================================================
  const ehCorrectionNicho = /nao\s+[eé]\s+nicho|isso\s+nao\s+[eé]\s+nicho|nao\s+sao\s+nicho|(tom\s+ford|mfk|byredo|jo\s+malone|le\s+labo).*nao\s+[eé]/.test(txtNorm);
  if (ehCorrectionNicho) {
    // Identificar qual marca o cliente está a corrigir
    const marcaCorrigida = /tom\s*ford/.test(txtNorm) ? 'Tom Ford' :
                           /mfk|maison\s*francis/.test(txtNorm) ? 'MFK' :
                           /byredo/.test(txtNorm) ? 'Byredo' :
                           /jo\s*malone/.test(txtNorm) ? 'Jo Malone' :
                           /le\s*labo/.test(txtNorm) ? 'Le Labo' : null;

    let resposta = `Tem razão`;
    if (marcaCorrigida) {
      resposta = `Tem razão — *${marcaCorrigida}* situa-se numa zona cinzenta entre o designer e o nicho puro. A distribuição é mais alargada que o nicho tradicional.

Nicho puro são casas como Mancera, Creed, Montale, Nishane, Amouage, Parfums de Marly — produção limitada, distribuição selectiva, fórmulas mais raras.`;
    } else {
      resposta = `Tem razão. Nicho puro são casas independentes como Mancera, Creed, Montale, Nishane, Amouage, Parfums de Marly — produção limitada e distribuição selectiva.`;
    }

    // Se havia uma sessão de sugestão activa, reiniciar sem a marca corrigida
    const criterioAnterior = sessao?.criterio || '';
    const generoAnterior = sessao?.genero || null;
    const orcAnterior = orcamento;

    // Sugerir nicho puro em alternativa
    const criterioNicho = criterioAnterior ? criterioAnterior + ' exclusivo' : 'exclusivo nicho';
    const sugestoesNicho = sugerirPorCriterio(criterioNicho, generoAnterior, orcAnterior);

    // Filtrar Tom Ford e outras zonas cinzentas das sugestões
    const ZONA_CINZENTA_MARCAS = ['Tom Ford', 'MFK', 'Maison Francis Kurkdjian', 'Byredo', 'Le Labo', 'Jo Malone'];
    if (sugestoesNicho) {
      sugestoesNicho.designers = [];
      sugestoesNicho.nicho = (sugestoesNicho.nicho || []).filter(p =>
        !ZONA_CINZENTA_MARCAS.some(m => p.nomeBase.includes(m))
      );
    }

    if (sugestoesNicho && sugestoesNicho.nicho && sugestoesNicho.nicho.length) {
      setSessao(from, { tipo: 'sugestao_activa', criterio: criterioNicho, genero: generoAnterior, orcamento: orcAnterior });
      return resposta + '\n\n' + formatarSugestoes(sugestoesNicho, 'nicho puro', orcAnterior);
    }

    return resposta + '\n\nQuer que sugira opções de nicho puro? Diga-me o perfil — para ele, para ela, e que tipo de sensação procura.';
  }
